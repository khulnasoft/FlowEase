...
const SlotTemplate: StoryFn = (args, { argTypes }) => ({
	...
	template:
		'<flowease-notice v-bind="args">This is a notice! Thread carefully from this point forward.</flowease-notice>',
});
...
const PropTemplate: StoryFn = (args, { argTypes }) => ({
	...
	template: '<flowease-notice v-bind="args"/>',
});
