...
export const caseTagFields: INodeProperties[] = [
	...
	},
	{
		...
		type: 'options',
		description:
			'Tag to attach to the case. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		required: true,
		default: '',
		typeOptions: {
