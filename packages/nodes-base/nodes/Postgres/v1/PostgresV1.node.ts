...
const versionDescription: INodeTypeDescription = {
	...
	properties: [
		...
		},
		{
			...
			default: '',
			// eslint-disable-next-line flowease-nodes-base/node-param-placeholder-miscased-id
			...
			options: [
				{
					...
					default: 'multiple',
					description:
						'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.flowease.khulnasoft.com/integrations/builtin/app-nodes/flowease-nodes-base.postgres/">the docs</a> for more examples',
				},
				{
