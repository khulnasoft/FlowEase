...
const properties: INodeProperties[] = [
	...
	{
		// eslint-disable-next-line flowease-nodes-base/node-param-display-name-miscased, flowease-nodes-base/node-param-display-name-wrong-for-dynamic-options
		...
		options: [
			{
				...
				name: 'rawData',
				type: 'boolean',
				// eslint-disable-next-line flowease-nodes-base/node-param-default-wrong-for-boolean
				default: 0,
				description:
