...
export const couponFields: INodeProperties[] = [
	...
	},
	{
		...
		default: [],
		description:
			'Comma-separated list of product IDs. Required if coupon_type is product. Choose from the list, or specify IDs using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		required: true,
	},
	{
