...
export class ExecutionData implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					"Use this node to save fields you want to use later to easily find an execution (e.g. a user ID). You'll be able to search by this data in the 'executions' tab.<br>This feature is available on our Pro and Enterprise plans. <a href='https://flowease.khulnasoft.com/pricing/' target='_blank'>More Info</a>.",
				name: 'notice',
				type: 'notice',
				default: '',
			},
