		...
		options: [
			{
				...
				default: '',
				description:
					'Only return the metric for this Plan ID. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
			},
			{
				displayName: 'Metrics',
				name: 'dailyMetrics',
