...
export async function apiRequest(
	...
	type FloweaseApiCredentials = {
		apiKey: string;
		baseUrl: string;
	};

	const credentials = (await this.getCredentials('floweaseApi')) as FloweaseApiCredentials;
	...
	try {
		return await this.helpers.requestWithAuthentication.call(this, 'floweaseApi', options);
	} catch (error) {
...
/**
 * Get a cursor-based paginator to use with flowease 'getAll' type endpoints.
 *
