...
const createOperation: INodeProperties[] = [
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. flowease account',
		required: true,
		displayOptions: {
			show: {
				resource: ['credential'],
	...
	},
	{
		...
		description:
			"The available types depend on nodes installed on the flowease instance. Some built-in types include e.g. 'githubApi', 'notionApi', and 'slackApi'.",
	},
	{
		displayName: 'Data',
		name: 'data',
		...
		default: '',
		placeholder:
			'// e.g. for floweaseApi \n{\n  "apiKey": "my-flowease-api-key",\n  "baseUrl": "https://<name>.app.flowease.cloud/api/v1",\n}',
		required: true,
		typeOptions: {
