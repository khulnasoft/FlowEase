...
export function errorMapper(
	...
	if (error.message.includes('Cannot create a string longer than')) {
		...
		description =
			'The binary file you are attempting to read exceeds 512MB, which is limit when using default binary data mode, try using the filesystem binary mode. More information <a href="https://docs.flowease.khulnasoft.com/hosting/scaling/binary-data/" target="_blank">here</a>.';
