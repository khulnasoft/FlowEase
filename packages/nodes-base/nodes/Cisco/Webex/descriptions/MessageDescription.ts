...
export const messageFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		name: 'roomId',
		description:
			'List messages in a room, by ID. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		type: 'options',
		typeOptions: {
			loadOptionsMethod: 'getRooms',
		},
