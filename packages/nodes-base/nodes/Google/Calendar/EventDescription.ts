	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The color of the event. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
			},
			{
