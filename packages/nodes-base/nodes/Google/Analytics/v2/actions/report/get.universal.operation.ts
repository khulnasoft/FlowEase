...
export const description: INodeProperties[] = [
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						description:
							'The name of the metric. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
						displayOptions: {
							show: {
								listName: ['other'],
							},
	...
	{
		// eslint-disable-next-line flowease-nodes-base/node-param-display-name-wrong-for-simplify
