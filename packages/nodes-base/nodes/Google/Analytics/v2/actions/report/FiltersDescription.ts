...
export const dimensionDropdown: INodeProperties[] = [
	...
	},
	{
		...
		default: 'date',
		description:
			'The name of the dimension. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		displayOptions: {
			show: {
				listName: ['other'],
			},
