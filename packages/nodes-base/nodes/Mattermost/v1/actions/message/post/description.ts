...
export const messagePostDescription: MessageProperties = [
	{
		...
		description:
			'The ID of the channel to post to. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Message',
		name: 'message',
