		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					default: 'keypair',
					// eslint-disable-next-line flowease-nodes-base/node-param-description-miscased-json
					description:
							...
							values: [
								{
									...
									default: '',
									description:
										'ID of the field to set. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
								},
								{
									displayName: 'Value',
									name: 'value',
				...
				},
				{
					...
					options: [
						...
						},
						{
							...
							noDataExpression: true,
							default: false,
							// eslint-disable-next-line flowease-nodes-base/node-param-description-wrong-for-ignore-ssl-issues
							description:
							...
							options: [
								{
									name: 'No Brackets',
									value: 'repeat',
									// eslint-disable-next-line flowease-nodes-base/node-param-description-lowercase-first-char
							...
							options: [
								{
									...
									values: [
										...
										},
										{
											...
											default: '',
											description:
												'Should evaluate to the URL of the next page. <a href="https://docs.flowease.khulnasoft.com/integrations/builtin/core-nodes/flowease-nodes-base.httprequest/#pagination" target="_blank">More info</a>.',
										},
										{
										...
										},
										{
											...
											default: '',
											description:
												'Should evaluate to true when pagination is complete. <a href="https://docs.flowease.khulnasoft.com/integrations/builtin/core-nodes/flowease-nodes-base.httprequest/#pagination" target="_blank">More info</a>.',
										},
										{
