		...
		properties: [
			{
				...
				default: '',
				// eslint-disable-next-line flowease-nodes-base/node-param-description-missing-final-period, flowease-nodes-base/node-param-description-wrong-for-dynamic-options
