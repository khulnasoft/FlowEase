...
export const rowFields: INodeProperties[] = [
...

	{
		...
		default: '',
		description:
			'The name of SeaTable table to access. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Table Name or ID',
		name: 'tableId',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'A column\'s name or ID, use this column to sort the rows. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
			},
		],
	},
];
