...
export const userDescription: INodeProperties[] = [
	...
	},
	{
		...
		type: 'string',
		description:
			'User to update. Specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'string',
		description:
			'User to delete. Specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'string',
		description:
			'User to retrieve. Specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'options',
				description:
					'Name of the organization to assign to the user. Choose from the list, or specify an ID using an <a href="https://docs.flowease.khulnasoft.com/code-examples/expressions/">expression</a>.',
				default: '',
				typeOptions: {
			...
			},
			{
				...
				type: 'string',
				default: '',
				placeholder: 'https://flowease.khulnasoft.com',
			},
		],
	},
	{
