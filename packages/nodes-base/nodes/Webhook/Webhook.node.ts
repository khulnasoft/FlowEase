/* eslint-disable flowease-nodes-base/node-execute-block-wrong-error-thrown */
...
export class Webhook extends Node {
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Insert a \'Respond to Webhook\' node to control when and how you respond. <a href="https://docs.flowease.khulnasoft.com/integrations/builtin/core-nodes/flowease-nodes-base.respondtowebhook/" target="_blank">More details</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: {
					show: {
	...
	async webhook(context: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		if (nodeVersion >= 2 && nodeType === 'flowease-nodes-base.webhook') {
