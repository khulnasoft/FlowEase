...
export class ChatTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Follow the instructions <a href="https://www.npmjs.com/package/@flowease/chat" target="_blank">here</a> to embed chat in a webpage (or just call the webhook URL at the top of this section). Chat will be live once you activate this workflow',
