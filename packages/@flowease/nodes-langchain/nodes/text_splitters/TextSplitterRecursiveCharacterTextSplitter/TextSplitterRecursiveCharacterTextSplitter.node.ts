		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.flowease.khulnasoft.com/integrations/builtin/cluster-nodes/sub-nodes/flowease-nodes-langchain.textsplitterrecursivecharactertextsplitter/',
					},
				],
			},
		},
