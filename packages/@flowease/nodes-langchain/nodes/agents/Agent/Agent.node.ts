		...
		specialInputs = [
			{
				...
				filter: {
					nodes: [
						'@flowease/flowease-nodes-langchain.lmChatAnthropic',
						'@flowease/flowease-nodes-langchain.lmChatGroq',
						'@flowease/flowease-nodes-langchain.lmChatOllama',
						'@flowease/flowease-nodes-langchain.lmChatOpenAi',
						'@flowease/flowease-nodes-langchain.lmChatGooglePalm',
						'@flowease/flowease-nodes-langchain.lmChatGoogleGemini',
						'@flowease/flowease-nodes-langchain.lmChatMistralCloud',
						'@flowease/flowease-nodes-langchain.lmChatAzureOpenAi',
					],
				},
			},
			{
...
export class Agent implements INodeType {
	description: INodeTypeDescription = {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.flowease.khulnasoft.com/integrations/builtin/cluster-nodes/root-nodes/flowease-nodes-langchain.agent/',
					},
				],
			},
		},
		...
		credentials: [
			{
				// eslint-disable-next-line flowease-nodes-base/node-class-description-credentials-name-unsuffixed
				name: 'mySql',
				required: true,
