...
const config = (module.exports = {
	...
	plugins: [
		 ...
		 * https://github.com/ivov/eslint-plugin-flowease-local-rules
		 */
	...
	rules: {
		 ...
		 */
		'sort-imports': 'off', // @TECH_DEBT: Enable, prefs to be decided - FLOWEASE-5821
		 ...
		 */
		'@typescript-eslint/triple-slash-reference': 'off', // @TECH_DEBT: Enable, disallowing in all cases - FLOWEASE-5820
		...
		'flowease-local-rules/no-uncaught-json-parse': 'error',

		'flowease-local-rules/no-json-parse-json-stringify': 'error',

		'flowease-local-rules/no-unneeded-backticks': 'error',

		'flowease-local-rules/no-interpolation-in-regular-string': 'error',

		'flowease-local-rules/no-unused-param-in-catch-clause': 'error',

		'flowease-local-rules/no-plain-errors': 'error',
	...
	overrides: [
		{
			...
			rules: {
				...
				'flowease-local-rules/no-skipped-tests':
				...
				'flowease-local-rules/no-uncaught-json-parse': 'off',
				'prefer-const': 'off',
				'prefer-spread': 'off',
			},
		},
