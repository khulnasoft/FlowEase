...
// node types
export const BAMBOO_HR_NODE_TYPE = 'flowease-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'flowease-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'flowease-nodes-base.code';
export const AI_CODE_NODE_TYPE = '@flowease/flowease-nodes-langchain.code';
export const CRON_NODE_TYPE = 'flowease-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'flowease-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'flowease-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'flowease-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'flowease-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'flowease-nodes-base.git';
export const GOOGLE_GMAIL_NODE_TYPE = 'flowease-nodes-base.gmail';
export const GOOGLE_SHEETS_NODE_TYPE = 'flowease-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'flowease-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'flowease-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'flowease-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'flowease-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'flowease-nodes-base.executeCommand';
export const FORM_TRIGGER_NODE_TYPE = 'flowease-nodes-base.formTrigger';
export const HTML_NODE_TYPE = 'flowease-nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = 'flowease-nodes-base.httpRequest';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'flowease-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'flowease-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'flowease-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'flowease-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'flowease-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'flowease-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'flowease-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'flowease-nodes-base.manualTrigger';
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@flowease/flowease-nodes-langchain.manualChatTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@flowease/flowease-nodes-langchain.chatTrigger';
export const AGENT_NODE_TYPE = '@flowease/flowease-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@flowease/flowease-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@flowease/flowease-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@flowease/flowease-nodes-langchain.openAiAssistant';
...
export const PAGERDUTY_NODE_TYPE = 'flowease-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'flowease-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'flowease-nodes-base.segment';
export const SET_NODE_TYPE = 'flowease-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'flowease-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'flowease-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'flowease-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'flowease-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'flowease-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'flowease-nodes-base.start';
export const SWITCH_NODE_TYPE = 'flowease-nodes-base.switch';
export const TELEGRAM_NODE_TYPE = 'flowease-nodes-base.telegram';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'flowease-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'flowease-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'flowease-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'flowease-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'flowease-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'flowease-nodes-base.workflowTrigger';
export const EXECUTE_WORKFLOW_NODE_TYPE = 'flowease-nodes-base.executeWorkflow';
export const EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = 'flowease-nodes-base.executeWorkflowTrigger';
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'flowease-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'flowease-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'flowease-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'flowease-nodes-base.zendeskTrigger';
export const DISCORD_NODE_TYPE = 'flowease-nodes-base.discord';
export const EXTRACT_FROM_FILE_NODE_TYPE = 'flowease-nodes-base.extractFromFile';
export const CONVERT_TO_FILE_NODE_TYPE = 'flowease-nodes-base.convertToFile';
export const DATETIME_NODE_TYPE = 'flowease-nodes-base.dateTime';
export const REMOVE_DUPLICATES_NODE_TYPE = 'flowease-nodes-base.removeDuplicates';
export const SPLIT_OUT_NODE_TYPE = 'flowease-nodes-base.splitOut';
export const LIMIT_NODE_TYPE = 'flowease-nodes-base.limit';
export const SUMMARIZE_NODE_TYPE = 'flowease-nodes-base.summarize';
export const AGGREGATE_NODE_TYPE = 'flowease-nodes-base.aggregate';
export const MERGE_NODE_TYPE = 'flowease-nodes-base.merge';
export const MARKDOWN_NODE_TYPE = 'flowease-nodes-base.markdown';
export const XML_NODE_TYPE = 'flowease-nodes-base.xml';
export const CRYPTO_NODE_TYPE = 'flowease-nodes-base.crypto';
export const RSS_READ_NODE_TYPE = 'flowease-nodes-base.rssFeedRead';
export const COMPRESSION_NODE_TYPE = 'flowease-nodes-base.compression';
export const EDIT_IMAGE_NODE_TYPE = 'flowease-nodes-base.editImage';
...
export const CREATOR_HUB_URL = 'https://creators.flowease.khulnasoft.com/hub';
