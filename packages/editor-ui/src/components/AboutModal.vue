		...
		<template #content>
			<div :class="$style.container">
				...
				<el-row>
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/khulnasoft/flowease">https://github.com/khulnasoft/flowease</n8n-link>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="8" class="info-name">
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/khulnasoft/flowease/blob/master/packages/cli/LICENSE.md">
