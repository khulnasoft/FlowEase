...
import ChatComponent from '@flowease/chat/components/Chat.vue';
import { ChatOptionsSymbol, ChatSymbol } from '@flowease/chat/constants';
import type { Chat, ChatMessage, ChatOptions } from '@flowease/chat/types';
