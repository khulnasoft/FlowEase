...
import { FloweaseAddInputEndpoint } from './FloweaseAddInputEndpointType';

export const register = () => {
	registerEndpointRenderer<FloweaseAddInputEndpoint>(FloweaseAddInputEndpoint.type, {
		makeNode: (endpointInstance: FloweaseAddInputEndpoint) => {
			const xOffset = 1;
			const lineYOffset = -2;
		...
		updateNode: (endpointInstance: FloweaseAddInputEndpoint) => {},
	});
};
