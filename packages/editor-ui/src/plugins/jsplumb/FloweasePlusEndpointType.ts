...
export type ComputedFloweasePlusEndpoint = [number, number, number, number, number];
export type FloweaseEndpointLabelLength = 'small' | 'medium' | 'large';
interface FloweasePlusEndpointParams extends EndpointRepresentationParams {
	dimensions: number;
	connectedEndpoint: Endpoint;
	hoverMessage: string;
	endpointLabelLength: FloweaseEndpointLabelLength;
	size: 'small' | 'medium';
	showOutputLabel: boolean;
}
export const PlusStalkOverlay = 'plus-stalk';
export const HoverMessageOverlay = 'hover-message';
export const FloweasePlusEndpointType = 'FloweasePlus';
export const EVENT_PLUS_ENDPOINT_CLICK = 'eventPlusEndpointClick';
export class FloweasePlusEndpoint extends EndpointRepresentation<ComputedFloweasePlusEndpoint> {
	params: FloweasePlusEndpointParams;
	...
	constructor(endpoint: Endpoint, params: FloweasePlusEndpointParams) {
	...
	static type = FloweasePlusEndpointType;
...
> = {
	...
	getParams: (ep: FloweasePlusEndpoint): FloweasePlusEndpointParams => {
		return ep.params;
	},
};
