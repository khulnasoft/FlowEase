...
import { FloweasePlusEndpoint } from './FloweasePlusEndpointType';

export const register = () => {
	registerEndpointRenderer<FloweasePlusEndpoint>(FloweasePlusEndpoint.type, {
		makeNode: (ep: FloweasePlusEndpoint) => {
		...
		updateNode: (ep: FloweasePlusEndpoint) => {
