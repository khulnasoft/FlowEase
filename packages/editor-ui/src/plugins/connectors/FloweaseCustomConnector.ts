...
export type FloweaseConnectorOptions = ConnectorOptions;
interface FloweaseConnectorPaintGeometry extends PaintGeometry {
...
export class FloweaseConnector extends AbstractConnector {
	static type = 'FloweaseConnector';
	...
	constructor(
		...
		params: FloweaseConnectorOptions,
	) {
	...
	writeFlowchartSegments(paintInfo: FloweaseConnectorPaintGeometry) {
	...
	_getPaintInfo(params: ConnectorComputeParams): FloweaseConnectorPaintGeometry {
	...
	_computeBezier(paintInfo: FloweaseConnectorPaintGeometry) {
	...
	_computeFlowchart(paintInfo: FloweaseConnectorPaintGeometry) {
		this.segments = [];
		this.lastx = null;
		this.lasty = null;
