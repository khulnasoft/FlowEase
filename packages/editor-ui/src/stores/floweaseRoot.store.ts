...
import { setGlobalState, type IDataObject } from 'flowease-workflow';
...
export const useRootStore = defineStore(STORES.ROOT, {
	...
	getters: {
		...
		getRestCloudApiContext(): IRestApiContext {
			return {
				baseUrl: window.location.host.includes('stage-app.flowease.cloud')
	...
	actions: {
		...
		setFloweaseMetadata(metadata: IDataObject): void {
			this.floweaseMetadata = metadata as RootState['floweaseMetadata'];
		},
