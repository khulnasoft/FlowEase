...
intersection.doc = {
	...
	args: [{ name: 'arr', type: 'Array' }],
	docURL:
		'https://docs.flowease.khulnasoft.com/code/builtin/data-transformation-functions/arrays/#array-intersection',
};
...
toJsonString.doc = {
	...
	docURL:
		'https://docs.flowease.khulnasoft.com/code/builtin/data-transformation-functions/arrays/#array-toJsonString',
	returnType: 'string',
};
