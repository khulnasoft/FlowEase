	...
	functions: {
		...
		search: {
			doc: {
				...
				examples: [
					{
						example: '"Neat flowease node".search(/n[^ ]*/)',
						evaluated: '5',
						description: "Pos of first word starting with 'n'",
					},
					{
						example: '"Neat flowease node".search(/n[^ ]*/i)',
						evaluated: '0',
						description:
		...
		slice: {
			doc: {
				...
				examples: [
					{ example: "'Hello from flowease'.slice(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from flowease'.slice(6)", evaluated: "'from flowease'" },
					{ example: "'Hello from flowease'.slice(-3)", evaluated: "'flowease'" },
				],
				section: 'edit',
				docURL:
		...
		substring: {
			doc: {
				...
				description:
					'Extracts a fragment of the string at the given position. For more advanced extraction, see <code>match()</code>.',
				examples: [
					{ example: "'Hello from flowease'.substring(0, 5)", evaluated: "'Hello'" },
					{ example: "'Hello from flowease'.substring(6)", evaluated: "'from flowease'" },
				],
				section: 'edit',
				docURL:
