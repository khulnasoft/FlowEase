...
import type { ICredentialsEncrypted } from 'flowease-workflow';
...
export class ImportCredentialsCommand extends BaseCommand {
	...
	static examples = [
		'$ flowease import:credentials --input=file.json',
		'$ flowease import:credentials --separate --input=backups/latest/',
		'$ flowease import:credentials --input=file.json --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
		'$ flowease import:credentials --separate --input=backups/latest/ --userId=1d64c3d2-85fe-4a83-a649-e446b07b3aae',
	];
