...
export class WorkflowExecutionService {
	 ...
	 * to the workflow, prioritizing `flowease-nodes-base.webhook` over other activators.
	 *
	 ...
	 * prioritizing `flowease-nodes-base.webhook` over other activators. If the executed node
		...
		return workflow.nodes
			.filter(
				(node) =>
					...
					node.type !== 'flowease-nodes-base.respondToWebhook',
			)
