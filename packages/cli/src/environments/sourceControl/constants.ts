...
export const SOURCE_CONTROL_GIT_KEY_COMMENT = 'flowease deploy key';
...
# flowease Source Control
`;
export const SOURCE_CONTROL_DEFAULT_NAME = 'flowease user';
export const SOURCE_CONTROL_DEFAULT_EMAIL = 'flowease@example.com';
