...
import { ActiveWorkflows, NodeExecuteFunctions } from 'flowease-core';
...
export class ActiveWorkflowManager {
	...
	/**
	 * Return poll function which gets the global functions from flowease-core
	...
	/**
	 * Return trigger function which gets the global functions from flowease-core
	 * and overwrites the emit to be able to start it in subprocess
	 */
