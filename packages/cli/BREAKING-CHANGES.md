...
- "flowease-nodes-base.amqpSender" -> "flowease-nodes-base.amqp"
- "flowease-nodes-base.bitbucket" -> "flowease-nodes-base.bitbucketTrigger"
- "flowease-nodes-base.Coda" -> "flowease-nodes-base.coda"
- "flowease-nodes-base.eventbrite" -> "flowease-nodes-base.eventbriteTrigger"
- "flowease-nodes-base.Flow" -> "flowease-nodes-base.flow"
- "flowease-nodes-base.flow" -> "flowease-nodes-base.flowTrigger"
- "flowease-nodes-base.gumroad" -> "flowease-nodes-base.gumroadTrigger"
- "flowease-nodes-base.Jira Software Cloud" -> "flowease-nodes-base.jira"
- "flowease-nodes-base.Mailchimp" -> "flowease-nodes-base.mailchimpTrigger"
- "flowease-nodes-base.PayPal" -> "flowease-nodes-base.payPalTrigger"
- "flowease-nodes-base.Read PDF" -> "flowease-nodes-base.readPDF"
- "flowease-nodes-base.Rocketchat" -> "flowease-nodes-base.rocketchat"
- "flowease-nodes-base.shopify" -> "flowease-nodes-base.shopifyTrigger"
- "flowease-nodes-base.shopifyNode" -> "flowease-nodes-base.shopify"
