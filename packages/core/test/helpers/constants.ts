...
import { Set } from 'flowease-nodes-base/nodes/Set/Set.node';
import { Start } from 'flowease-nodes-base/nodes/Start/Start.node';
...
export const predefinedNodesTypes: INodeTypeData = {
	...
	'flowease-nodes-base.merge': {
		type: new Merge(),
		sourcePath: '',
	},
	'flowease-nodes-base.noOp': {
		type: new NoOp(),
		sourcePath: '',
	},
	'flowease-nodes-base.set': {
		type: new Set(),
		sourcePath: '',
	},
	...
	'flowease-nodes-base.versionTest': {
		sourcePath: '',
		type: {
			description: {
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						name: 'Merge3',
						type: 'flowease-nodes-base.merge',
						typeVersion: 1,
						position: [1100, 1060],
					},
					{
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						parameters: {},
						name: 'VersionTest1a',
						type: 'flowease-nodes-base.versionTest',
						typeVersion: 1,
						position: [460, 300],
					},
					{
